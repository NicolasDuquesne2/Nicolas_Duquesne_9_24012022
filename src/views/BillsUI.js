...
import {formatShortMonthFrench} from "../app/format.js"
...
const rows = (data) => {
  return (data && data.length) ? data.sort((a,b) => (new Date(formatShortMonthFrench(a.date)) < new Date(formatShortMonthFrench(b.date)) ? 1: -1))
